...
## Handoff Integrity
1. Handoff Alignment: Always read the active session handoff document located in handoff_session_1.9/ before starting work to maintain continuity and alignment with the previous agent's progress.
